...
class Utils extends UtilsArrays
{
    ...
    {
        if (APP || Server::isLocalhost() || Session::isAdmin() || Session::isSupport()) {
            return "";
        }
    ...
    {
        if (empty($code) || Server::isLocalhost()) {
            return;
        } // Don't put analytics for localhost
    ...
    static function getImageDimensions($fileName)
    {
        ...
        return ["width" => $match['width'], "height" => $match['height'], "text" => $match[0]];
    }
