...
class UtilsStrings extends UtilsRequests
{
    ...
    static function identifyCreditCard($workStr)
    {
        ...
        if (($chars1 == '4') && (($len == 16) || ($len == 13))) {
            return 'Visa';
        }              // Visa
        if (($len == 16) && ($chars2 >= '51') && ($chars2 <= '55')) {
            return 'MasterCard';
        }     // MasterCard
        if (($len == 15) && (($chars2 == '34') || ($chars2 == '37'))) {
            return 'Amex';
        }        // AmEx
        if (($chars4 == '6011') && ($len == 16)) {
            return 'Discover';
        }                         // Discover
        if (($chars2 == '38') && ($len == 14)) {
            return 'CarteBlanche';
        }                       // CarteBlanche
        if ((($chars4 == '2014') || ($chars4 == '2149')) && ($len == 15)) {
            return 'EnRoute';
        } // EnRoute
        if ((($chars4 == '2131') || ($chars4 == '1800')) && ($len == 15)) {
            return 'JCB';
        }     // JCB
        if (($chars1 == '3') && ($len == 16)) {
            return 'JCB';
    ...
    static function decodeURI($encoded)
    {
        ...
        if (!$decoded) {
            return false;
        }                  // If value cannot be converted then return
