...
//        set_error_handler($this->errorHandler(...));
    ...
    public function checkServerTalk()
    {
        ...
        if (Server::isLocalhost()) {
            Console::error('This was a localhost');
            return true;
        }
