    ...
    <head>
        ...
        <script>
            ...
            function migrateAll(){
                ...
                window.parent.Admin.migrateAllSubmissions({
                    ...
                    callback: function(response){
                        if (response.success) {
                            ...
                            // Print last success time as well.
                            var now = new Date();
                            $('lastTime').update(" Last Time: " + now.getHours() + ":" + now.getMinutes());
    ...
    <body>
        <div style="padding:10px;">
            <div>
                ...
                <span id="avgTime"></span><span id="lastTime"></span>
            </div>
            <div id="error"></div>
            <div id="response"></div>
        </div>
